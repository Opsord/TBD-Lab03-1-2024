...
INSERT INTO user (rut, email, name, last_name, birth_date, sex, password, role, availability)
VALUES
...
UPDATE user SET location = 1 WHERE rut = '123271472-1';
UPDATE user SET location = 2 WHERE rut = '176271472-1';
UPDATE user SET location = 3 WHERE rut = '182473567-4';
UPDATE user SET location = 4 WHERE rut = '2421283874-4';
UPDATE user SET location = 30 WHERE rut = '3641746726-4';
UPDATE user SET location = 5 WHERE rut = '4152351623-5';
UPDATE user SET location = 7 WHERE rut = '42163612342-5';
UPDATE user SET location = 8 WHERE rut = '4412317123-k';
UPDATE user SET location = 9 WHERE rut = '5872873212-4';
UPDATE user SET location = 10 WHERE rut = '61523512412-5';
UPDATE user SET location = 11 WHERE rut = '65265412312-k';
UPDATE user SET location = 12 WHERE rut = '6527442312-k';
UPDATE user SET location = 13 WHERE rut = '6717263715312-k';
UPDATE user SET location = 27 WHERE rut = '7123674212-5';
UPDATE user SET location = 15 WHERE rut = '7126371263-k';
UPDATE user SET location = 16 WHERE rut = '71264646674-4';
UPDATE user SET location = 17 WHERE rut = '7126476122-4';
UPDATE user SET location = 18 WHERE rut = '7146176122-4';
UPDATE user SET location = 19 WHERE rut = '7723674212-5';
UPDATE user SET location = 20 WHERE rut = '81723817246-1';
UPDATE user SET location = 21 WHERE rut = '876327463-4';
UPDATE user SET location = 22 WHERE rut = '881263612-k';
UPDATE user SET location = 23 WHERE rut = '948128124-1';
UPDATE user SET location = 24 WHERE rut = '98482714-4';
